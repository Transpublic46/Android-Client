...
import se.poochoo.R;
import se.poochoo.cardsui.StackAdapter;
import se.poochoo.cardsui.SwipeDismissTouchListener;
import se.poochoo.cardsui.SwipeDismissTouchListener.OnDismissCallback;
		...
		return new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				if (index == 0) {
					...
					clickedCard
							.setBackgroundResource(se.poochoo.R.drawable.card_background);
				}
